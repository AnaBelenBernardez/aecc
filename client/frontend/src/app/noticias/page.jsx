                ...
                <Link href={`${newItem.link}`} target='_blank' key={newItem.id}>
                  <article className='flex justify-between p-8 items-center shadow-md'>
                    <div className='flex items-center'>
                      <p className='w-[52px] text-center flex items-center text-lightPink font-bold'>{new Date(newItem.news_date).toLocaleDateString('es-ES', { month: 'short', day: '2-digit', year: 'numeric' }).toLocaleUpperCase()}</p>
