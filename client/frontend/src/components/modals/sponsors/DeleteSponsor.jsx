...
const DeleteSponsor = ({ handleClickDelete, setDeleteModalOpen }) => {
  return (
    <div className='fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50'>
      <div className='w-[90vw] bg-secondLightGray p-4 rounded-xl shadow-xl md:w-[50vh] lg:w-[60vh]'>
        <p className='font-bold text-lg text-balance text-center'>¿Estás seguro de que quieres eliminar este patrocinador?</p>
