...
const DeleteExperienceModal = ({ handleClickDelete, setDeleteModalOpen }) => {
  return (
    <div className='fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50'>
      <div className='w-[70vw] max-h-[40vh] bg-secondLightGray p-4 rounded-xl shadow-xl lg:w-[40vw]'>
          <p className='font-bold text-lg text-balance text-center'>¿Estás seguro de que quieres eliminar esta experiencia?</p>
